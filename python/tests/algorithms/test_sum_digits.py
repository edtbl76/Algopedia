...
class TestSumDigits(unittest.TestCase):
    def test_sum_digits_iterative_zero(self):
        """Test iterative sum_digits of 0"""
        result = sum_digits_iterative(0)
        self.assertEqual(result, 0)

    def test_sum_digits_iterative_single_digit(self):
    ...
    def test_sum_digits_iterative_two_digits(self):
    ...
    def test_sum_digits_iterative_three_digits(self):
    ...
    def test_sum_digits_iterative_larger_numbers(self):
    ...
    def test_sum_digits_iterative_numbers_with_zeros(self):
    ...
    def test_sum_digits_iterative_negative_number(self):
    ...
    def test_sum_digits_recursive_zero(self):
        """Test recursive sum_digits of 0"""
        result = sum_digits_recursive(0)
        self.assertEqual(result, 0)

    def test_sum_digits_recursive_single_digit(self):
    ...
    def test_sum_digits_recursive_two_digits(self):
    ...
    def test_sum_digits_recursive_three_digits(self):
    ...
    def test_sum_digits_recursive_larger_numbers(self):
    ...
    def test_sum_digits_recursive_numbers_with_zeros(self):
    ...
    def test_sum_digits_recursive_negative_number(self):
    ...
    def test_recursive_vs_iterative_consistency(self):
        ...
        test_values = [0, 1, 5, 9, 12, 23, 99, 123, 456, 999, 1234, 56789, 987654321, 101, 1000, 2050]

        for n in test_values:
            with self.subTest(n=n):
                recursive_result = sum_digits_recursive(n)
                iterative_result = sum_digits_iterative(n)
