...
class TestLinkedList(unittest.TestCase):
    def test_init(self):
        ...
        self.assertEqual(ll.get_head().data, 5)
        self.assertIsNone(ll.get_head().next)

        # Test with None value
        ll = LinkedList()
        self.assertIsNotNone(ll.get_head())
        self.assertIsNone(ll.get_head().data)
        self.assertIsNone(ll.get_head().next)
    ...
    def test_insert_start(self):
        ...
        self.assertEqual(ll.get_head().data, 10)
        self.assertEqual(ll.get_head().next.data, 5)

        # Insert another node at the start
        ll.insert_start(15)

        # Verify the newest node is now the head
        self.assertEqual(ll.get_head().data, 15)
        self.assertEqual(ll.get_head().next.data, 10)
        self.assertEqual(ll.get_head().next.next.data, 5)
    ...
    def test_swap_node(self):
        ...
        self.assertEqual(ll.get_head().data, 20)
        self.assertEqual(ll.get_head().next.data, 10)
        self.assertEqual(ll.get_head().next.next.data, 15)
        self.assertEqual(ll.get_head().next.next.next.data, 5)
